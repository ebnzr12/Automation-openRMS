...
public class RegisterDuplicatePatient2 {
    public static void main(String[] args) {
        ...
        String phoneNumber = ("01213129042");
        String personName = ("Jui");      
        ...
        try {
            ...
            Select patientRelated = new Select (driver.findElement(By.id("relationship_type")));
            patientRelated.selectByIndex(9);
            
            WebElement inputPersonName = driver.findElement(By.xpath("/html/body/div/div[3]/form/section[3]/div/fieldset/div/div/p[2]/input[1]"));
            inputPersonName.sendKeys(personName);
            Thread.sleep(500);
            nextButton.click();
            Thread.sleep(4000);
			   ...
			   if (driver.getPageSource().contains(" similar patient(s) found")) { 
			  System.out.println("Similar patient(s) found"); } else { 
			  System.out.println("No similar patient(s) found"); }
