...
public class RegisterPatientWithValidData {
    public static void main(String[] args) {
        ...
        String phoneNumber = ("091091000111");
        ...
        try {
            ...
            Thread.sleep(3000);
			  ...
			  System.out.println("New patient successfully registered"); } else { 
			  System.out.println("New patient failed to register"); }
