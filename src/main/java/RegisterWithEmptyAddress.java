...
public class RegisterWithEmptyAddress {
    public static void main(String[] args) {
        ...
        try {
            ...
            Thread.sleep(4000);
			   ...
			   if (driver.getPageSource().contains("You need to provide a value for at least one field")) { 
			  System.out.println("Address field must be fill"); } else { 
